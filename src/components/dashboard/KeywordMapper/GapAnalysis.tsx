...
export default function GapAnalysis({ gaps, totalMatched, totalJD }: Props) {
  const coveragePercent = totalJD > 0 ? Math.round((totalMatched / totalJD) * 100) : 0;
    ...
    <div className="space-y-5">
      ...
      <div className="p-4 rounded-xl border border-border bg-muted/30">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-foreground">JD Coverage</span>
        ...
        <div className="h-2 bg-border rounded-full overflow-hidden">
          <div
            ...
            style={{
              ...
              background: coveragePercent >= 70 ? "#16a34a" : coveragePercent >= 40 ? "#ca8a04" : "#dc2626",
            }}
          />
        </div>
        <p className="text-xs text-muted-foreground mt-2">
          {totalMatched} of {totalJD} job description keywords found in your resume
        </p>
      </div>
      ...
      {gaps.length === 0 ? (
        <div className="flex flex-col items-center gap-2 py-8 text-center">
          ...
          <p className="text-sm font-medium text-foreground">Excellent coverage!</p>
        ...
        <>
          ...
          <p className="text-xs text-muted-foreground -mt-3">
            These keywords appear in the job description but aren&apos;t supported by your resume.
          </p>
            ...
            {gaps.map(kw => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className="text-sm font-medium text-foreground">{kw.label}</span>
                </div>
                <span
          ...
          <p className="text-xs text-muted-foreground pt-1 px-1">
            Consider adding these keywords to your experience or skills section where genuinely applicable.
          </p>
        </>
      )}
    </div>
